...
CONF_IGNORE_PULSE_MIN = "ignore_pulse_min"
CONF_IGNORE_PULSE_MAX = "ignore_pulse_max"
...
CONFIG_SCHEMA = cv.COMPONENT_SCHEMA.extend(
    {
        ...
        cv.Optional(CONF_IGNORE_PULSE_MIN, default="0us"): cv.positive_time_period_microseconds,
        cv.Optional(CONF_IGNORE_PULSE_MAX, default="0us"): cv.positive_time_period_microseconds,
    }
)
...
async def to_code(config):
    ...
    cg.add(var.set_ignore_pulse_min(config[CONF_IGNORE_PULSE_MIN]))
    cg.add(var.set_ignore_pulse_max(config[CONF_IGNORE_PULSE_MAX]))
